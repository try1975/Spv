...
{
    public partial class spv_dbContext
    {
        private Ispv_dbContextProcedures _procedures;

        public virtual Ispv_dbContextProcedures Procedures
        {
            get
            {
                if (_procedures is null) _procedures = new spv_dbContextProcedures(this);
                return _procedures;
            }
            set
            {
        ...
        public Ispv_dbContextProcedures GetProcedures()
        {
            return Procedures;
        }
    }

    public partial class spv_dbContextProcedures : Ispv_dbContextProcedures
    {
        private readonly spv_dbContext _context;

        public spv_dbContextProcedures(spv_dbContext context)
        {
            _context = context;
        }
